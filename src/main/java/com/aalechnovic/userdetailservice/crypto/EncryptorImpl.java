...
public class EncryptorImpl implements Encryptor {
    ...
    private final int SECRET_KEY_ITERATION_COUNT = 65536;
    private final int SECRET_KEY_LENGTH = 256;
    private final String SECRET_KEY_GEN_ALGO = "PBKDF2WithHmacSHA256";
    private final String SECRET_KEY_SPEC_ALGO = "AES";
     ...
     */
    @Override
    public Pair<SealedObject, byte[]> encryptObject(Serializable object, SecretKey key) {
     ...
     */
    @Override
    public Serializable decryptObject(SealedObject sealedObject, SecretKey key, byte[] randomBytes)  {
        try {
        Cipher cipher = Cipher.getInstance(CIPHER_TRANSFORMATION);
